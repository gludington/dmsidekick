...
describe("Parsing Tests Tests", () => {
  ...
  it("Can convert a Kobold with delimited senses", () => {
    ...
    assert.deepEqual(monster.speed, { walk: "30 ft." });
...
describe("Preparsing", () => {
  ...
  //this one shows errors but the json in the output error message looks correct
  xit("can handle the peg leg", () => {
